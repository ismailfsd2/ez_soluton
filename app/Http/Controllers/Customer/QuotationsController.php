...
class QuotationsController extends BaseController
{
    ...
    public function index(){
        $this->data['rows'] = Quotations::select('quotations.*','customers.name as customer')
                                ...
                                ->get();
        return view($this->data['active_theme'].'/customer/quotations/list',$this->data);
    }
    public function create(){
        return view($this->data['active_theme'].'/customer/quotations/create',$this->data);
    }
    public function store(Request $request){
        ...
        return redirect()->route('customer.quotations.list')
    ...
    public function detail($id){
        ...
        return view($this->data['active_theme'].'/customer/quotations/view',$this->data);
    }
}
