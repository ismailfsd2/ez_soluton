                        ...
                        <div class="flex-shrink-0">
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: left;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('admin.quotations.list') }}">Quotations</a>
                                </li>
                            </ul>
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: right;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('admin.quotations.create') }}" style="background: #009edc;" ><i class="bx bx-user-plus"></i> Add Quotation</a>
                                </li>
                            </ul>
                        </div>
                    </div>
