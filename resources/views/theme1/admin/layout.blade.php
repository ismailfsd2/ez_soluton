...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.brands.list') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.products.list') }}">
                        ...
                        <!-- <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarEmployees">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.employees.list') }}" class="nav-link" data-key="t-analytics"> List  </a>
                                        <a href="{{ route('admin.employees.add') }}" class="nav-link" data-key="t-analytics"> Add Employee </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarVendors" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarVendors">
                                <i class="ri-honour-line"></i> <span data-key="t-vendors">Vendors</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarVendors">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.vendors.list') }}" class="nav-link" data-key="t-analytics"> List  </a>
                                        <a href="{{ route('admin.vendors.add') }}" class="nav-link" data-key="t-analytics"> Add Vendor </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarCustomers" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCustomers">
                                <i class="ri-honour-line"></i> <span data-key="t-customers">Customers</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarCustomers">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.customers.list') }}" class="nav-link" data-key="t-analytics"> List  </a>
                                        <a href="{{ route('admin.customers.add') }}" class="nav-link" data-key="t-analytics"> Add Customer </a>
                                    </li>
                                </ul>
                            </div>
                        </li> -->
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                <div class="col-12">
                    <button type="button" class="btn btn-warning w-100" id="reset-layout">Reset</button>
                </div>
            </div>
        </div>
    </div>
