                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            ...
                            <div class="col-md-12">
                                <form action="{{ route('admin.employees.store') }}" class="needs-validation" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <a href="{{ route('admin.employees.list') }}" class="btn btn-danger">Cancel</a>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
