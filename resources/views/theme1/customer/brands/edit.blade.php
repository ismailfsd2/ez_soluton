                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="{{ route('customer.brands.update') }}" method="post" enctype="multipart/form-data" >
                                @csrf
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" required value="{{ $brand[0]->name}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
