                        ...
                        <div class="flex-shrink-0">
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: left;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('customer.products.list') }}">Brands</a>
                                </li>
                            </ul>
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: right;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('customer.brands.add') }}" style="background: #009edc;" ><i class="bx bx-user-plus"></i> Add Brand</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--datatable js-->
    ...
    <script>
        $.DataTableInit({
            ...
            url: "{{ route('customer.brands.data') }}",
            data:{},
            config:{
                processing:true
            },
