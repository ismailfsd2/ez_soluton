                        ...
                        <div class="flex-shrink-0">
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: left;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active"href="#">Customer Point of Contacts</a>
                                </li>
                            </ul>
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: right;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active"href="{{ route('customer.customers.poc.add',$id) }}" style="background: #009edc;" ><i class="bx bx-user-plus"></i> Add New POC</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--datatable js-->
    ...
    <script>
        $.DataTableInit({
            ...
            url: "{{ route('customer.customers.poc.data') }}",
            data:{id:{{ $id }}},
            config:{
                processing:true
            },
