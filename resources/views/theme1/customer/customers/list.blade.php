                    ...
                    <div class="card-header">
                        ...
                        <div class="flex-shrink-0">
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: left;">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active"href="{{ route('customer.customers.list') }}">Customers</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('customer.manufacturers.list') }}">Manufacturers</a>
                                </li>
                            </ul>
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: right;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active"href="{{ route('customer.customers.add') }}" style="background: #009edc;" ><i class="bx bx-user-plus"></i> Add Customer</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--datatable js-->
    ...
    <script>
        $.DataTableInit({
            ...
            url: "{{ route('customer.customers.data') }}",
            data:{},
            config:{
                processing:true
            },
