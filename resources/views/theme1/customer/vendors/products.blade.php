            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('customer.vendors.products.add') }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="row gy-4">
                                        <div class="col-xxl-4 col-md-6">
                                            <div>
                                                ...
                                                <select name="product_id" class="form-control products_select2" required>
                                ...
                                <table id="CustomerTable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('customer.vendors.products.destroy',$product->id) }}" class="btn btn-danger waves-effect waves-light">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<!--datatable js-->
    ...
    <script>
        ...
        $('.products_select2').select2({
            ajax: {
                url: '{{ route("customer.general.select.products") }}',
                dataType: 'json',
            },
