                        ...
                        <div class="flex-shrink-0">
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: left;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('customer.employees.list') }}">Employees</a>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <ul class="nav nav-pills card-header-pills" role="tablist" style="float: right;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="{{ route('customer.employees.add') }}" style="background: #009edc;" ><i class="bx bx-user-plus"></i> Add Employee</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--datatable js-->
    ...
    <script>
        $.DataTableInit({
            ...
            url: "{{ route('customer.employees.data') }}",
            data:{},
            config:{
                processing:true
            },
